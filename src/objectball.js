...
function teamNames(){
  const teamNamesArray = Object.entries(gameObject()).map( array => {
    return array[1].teamName
  })
...
const teamNamesRach = () =>{
  ...
  nameArray.push(homeName,awayName)
  return nameArray

}
// takes in team name, returns array of jersey numbers
...
// takes in name, returns player object
